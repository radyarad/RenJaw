      ...
      <div className="flex">
        <form className="z-50">
          <div className="bg-white shadow-lg p-10 w-[400px] mx-10 mt-28">
            ...
            <h2 className={`${lato.className} text-[#737373] mb-5 text-center`}>Its fast and easy to start renting a car</h2>
            ...
            <div className="relative">
              ...
              <input type="text" name="phone number" id="phone number" placeholder="Phone Number" className="mb-4 pl-10 w-full py-2 border border-[#DFDFDF] text-[#737373] focus:outline-none"/>
            </div>
            <div className="relative">
              <div className="absolute top-3 inset-y-0 left-0 pl-3 flex item-center">
            ...
            <div className="relative">
              ...
              <input type="password" name="confirm password" id="confirm password" placeholder="Confirm Password" className="mb-4 pl-10 w-full py-2 border border-[#DFDFDF] text-[#737373] focus:outline-none"/>
            </div>
            <div>
              <button type="submit" className="mb-4 w-full py-2 bg-[#D80032] hover:bg-red-700 text-white cursor-pointer">Sign Up</button>
              <p 
                className="mb-2 text-center">Already have an account?
              </p>
              <a href="" className="text-[#D80032] mx-35">Login</a>
            </div>
          </div>
        </form>
      </div>
