  ...
  return (
    <main className="flex h-screen">
      <div className="flex flex-col">
        <div
          className={`${racing.className} px-10 py-12 flex flex-rows relative text-2xl`}
        >
        ...
        <div className="flex px-10 items-center">
          <form className="z-50">
            <div className="bg-white shadow-lg p-10 w-[400px]">
              <h1
                className={`${lato.className} text-3xl text-black font-bold mb-2 text-center`}
              >
                Welcome Back!
              </h1>
              <h2
                className={`${lato.className} text-[#737373] mb-5 text-center`}
              >
              ...
              <div>
                <input
                  type="checkbox"
                  id="remember"
                  className="mb-6 accent-[#D80032] cursor-pointer"
                />
              ...
              <div>
                ...
                <p className="mb-2 text-center">Dont have an account?</p>
                <a href="/register" className="text-[#D80032] mx-32">
                  Sign Up
                </a>
              </div>
            </div>
      ...
      <div className="relative top-10 bottom-0 right-0 z-10">
        <Image
          src="/toyota.png"
          alt="mobil"
          width={680}
